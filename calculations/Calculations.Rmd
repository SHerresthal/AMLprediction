...
This script includes all calculations of figures 2 and 4 and S2-S7 and S10-12 of the manuscript *Warnat-Herresthal, Perrakis et al 2019, Scalable diagnosis of acute myeloid leukemia using high-dimensional machine learning and blood transcriptomics* . 

To run the script, we recommend to use our docker container in schultzelab/AML_classifier:0.0.1

The first part of the script calculates the prediction, the second parts summarized the results and returns the file *results_summary.txt* as output. This file is also provided on github. 
...
This part of the script is used to summarize all results in one table *after* the calculations are done. 
